...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        self.w1 = w1 = tf.Variable(initializer((self.config.n_features * self.config.embed_size, self.config.hidden_size)))
        self.w2 = w2 = tf.Variable(initializer((self.config.hidden_size, self.config.n_classes)))
        b1 = tf.Variable(initializer((self.config.hidden_size,)))
        b2 = tf.Variable(initializer((self.config.n_classes,)))
